import { editButton, saveButton, exitButton, changes, postRelated, postSubmission, setNewPfp, getNewPfp } from "../professionalProfile";

let editBtn, saveBtn, editBox, closeEB, nameFr, experience, sidebarPfp, pfpMain, profilePicInput, fileInput, editNameInput, editExperienceInput, nameLimit, addPostBtn, postModal, closePostModal, submitPost, postText, postMedia, postList, newPfp;
...
beforeEach(() => {
  ...
  editExperienceInput = document.createElement('input');
...
test('saveButton', () => {
  ...
  editExperienceInput.value = '4';
  setNewPfp('pic2.jpg');
  saveBtn.click();
  expect(nameFr.textContent).toBe('Aimee');
  expect(experience.textContent).toBe('🌿 4+ years of experience');
