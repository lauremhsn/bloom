import { editButton, saveButton, exitButton, changes, postRelated, postSubmission, setNewPfp, getNewPfp } from "../NGOProfile";

let editBtn, saveBtn, editBox, closeEB, nameFr, sidebarPfp, pfpMain, profilePicInput, fileInput, editNameInput, nameLimit, addPostBtn, postModal, closePostModal, submitPost, postText, postMedia, postList, newPfp, editMissionInput, mission;
...
beforeEach(() => {
  ...
  editMissionInput = document.createElement('input');
...
test('saveButton', () => {
  ...
  editMissionInput.value = 'true';
  setNewPfp('pic2.jpg');
  saveBtn.click();
  expect(nameFr.textContent).toBe('Aimee');
  expect(mission.textContent).toBe('🌿 true');
