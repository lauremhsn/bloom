import { editButton, saveButton, exitButton, changes, postRelated, postSubmission, setNewPfp, getNewPfp } from "../profile";

let editBtn, saveBtn, editBox, closeEB, nameFr, sidebarPfp, pfpMain, profilePicInput, fileInput, editNameInput, nameLimit, addPostBtn, postModal, closePostModal, submitPost, postText, postMedia, postList, newPfp;
...
test('saveButton', () => {
  saveButton(saveBtn, editNameInput, nameFr, pfpMain, sidebarPfp, editBox)
